CREATE INDEX "profile_history_user_id_idx" ON "profile_history" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "profile_history_date_idx" ON "profile_history" USING btree ("recorded_at");--> statement-breakpoint
