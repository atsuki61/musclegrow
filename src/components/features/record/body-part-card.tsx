  ...
  return (
    <Card className="p-2.5">
      ...
      <div className="mb-2 flex items-center justify-between">
        <h2 className="text-base font-bold">{bodyPart}</h2>
                  ...
                  {initialSubGroupExercises.map((exercise) => {
                    ...
                    return (
                      <button
                        ...
                        className="flex flex-col items-start justify-start rounded-md border bg-card p-2 text-left transition-colors hover:bg-muted active:bg-muted/80"
                      >
      ...
      <button
        ...
        className="mt-2.5 w-full rounded-md border bg-background px-3 py-1.5 text-xs font-medium transition-colors hover:bg-muted"
      >
        種目を追加
      </button>
    </Card>
