    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-32">
      ...
      <div className="pt-8 pb-4 flex flex-col items-center justify-center space-y-3 bg-gradient-to-b from-background to-muted/20">
        <div className="relative">
          {/* 
            修正: 背景グラデーションをテーマカラー(primary)基準に変更 
            from-primary to-primary/80 などを使用
          */}
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center text-primary-foreground shadow-xl shadow-primary/20 ring-4 ring-background">
